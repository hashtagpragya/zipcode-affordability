<script>
  ...
  import InterConnected from "./InterConnected.svelte";
    ...
    onMount(async () => {
        ...
        houses = await d3.csv("https://raw.githubusercontent.com/hashtagpragya/hashtagpragya.github.io/main/Smaller_dataset_1000.csv").then(houses => {
            return houses;
        });
...
<div class="footer">
    ...
    <p>
        ...
        This project was developed with guidance and feedback from the <a href = "https://www.mapc.org/">Metropolitan Area Planning Commission (MAPC)</a> . This website is created as part of Massachusetts Institute of Technology's Interactive Data Visualization & Society (Spring 2024) coursework. We would like to express thanks to the instructors Arvind Satyanarayan and Catherine D'Ignazio as well as the course staff and our classmates for valuable comments and suggestions.</p>
  </div>
